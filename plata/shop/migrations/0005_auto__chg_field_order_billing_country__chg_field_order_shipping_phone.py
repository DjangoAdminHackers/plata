...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'shop_order', 'billing_country', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Order.shipping_phone'
        db.alter_column(u'shop_order', 'shipping_phone', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Order.billing_country'
        db.alter_column(u'shop_order', 'billing_country', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True))

        # Changing field 'Order.shipping_phone'
        db.alter_column(u'shop_order', 'shipping_phone', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 7, 40, 27, 690904)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 7, 40, 27, 690546)'}),
