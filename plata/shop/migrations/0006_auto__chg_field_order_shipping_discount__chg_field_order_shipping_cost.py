...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.shipping_discount'
        db.alter_column(u'shop_order', 'shipping_discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=4, blank=True))

        # Changing field 'Order.shipping_cost'
        db.alter_column(u'shop_order', 'shipping_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=4, blank=True))

        # Changing field 'Order.total'
        db.alter_column(u'shop_order', 'total', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'Order.shipping_tax'
        db.alter_column(u'shop_order', 'shipping_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'Order.items_discount'
        db.alter_column(u'shop_order', 'items_discount', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'Order.paid'
        db.alter_column(u'shop_order', 'paid', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'Order.items_tax'
        db.alter_column(u'shop_order', 'items_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'Order.items_subtotal'
        db.alter_column(u'shop_order', 'items_subtotal', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'OrderItem._unit_price'
        db.alter_column(u'shop_orderitem', '_unit_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'OrderItem._unit_tax'
        db.alter_column(u'shop_orderitem', '_unit_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'OrderItem._line_item_tax'
        db.alter_column(u'shop_orderitem', '_line_item_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'OrderItem._line_item_discount'
        db.alter_column(u'shop_orderitem', '_line_item_discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=4, blank=True))

        # Changing field 'OrderItem._line_item_price'
        db.alter_column(u'shop_orderitem', '_line_item_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))


    def backwards(self, orm):
        
        # Changing field 'Order.shipping_discount'
        db.alter_column(u'shop_order', 'shipping_discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=10, blank=True))

        # Changing field 'Order.shipping_cost'
        db.alter_column(u'shop_order', 'shipping_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=10, blank=True))

        # Changing field 'Order.total'
        db.alter_column(u'shop_order', 'total', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'Order.shipping_tax'
        db.alter_column(u'shop_order', 'shipping_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'Order.items_discount'
        db.alter_column(u'shop_order', 'items_discount', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'Order.paid'
        db.alter_column(u'shop_order', 'paid', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'Order.items_tax'
        db.alter_column(u'shop_order', 'items_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'Order.items_subtotal'
        db.alter_column(u'shop_order', 'items_subtotal', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'OrderItem._unit_price'
        db.alter_column(u'shop_orderitem', '_unit_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'OrderItem._unit_tax'
        db.alter_column(u'shop_orderitem', '_unit_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'OrderItem._line_item_tax'
        db.alter_column(u'shop_orderitem', '_line_item_tax', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'OrderItem._line_item_discount'
        db.alter_column(u'shop_orderitem', '_line_item_discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=10, blank=True))

        # Changing field 'OrderItem._line_item_price'
        db.alter_column(u'shop_orderitem', '_line_item_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 11, 24, 12, 776038)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 11, 24, 12, 775695)'}),
