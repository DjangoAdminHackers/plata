...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.billing_country'
        db.alter_column(u'contact_contact', 'billing_country', self.gf('django.db.models.fields.CharField')(max_length=3))


    def backwards(self, orm):
        
        # Changing field 'Contact.billing_country'
        db.alter_column(u'contact_contact', 'billing_country', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 7, 40, 5, 426043)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 7, 40, 5, 425708)'}),
