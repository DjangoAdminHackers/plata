...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Discount.is_active'
        db.alter_column(u'discount_discount', 'is_active', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Discount.value'
        db.alter_column(u'discount_discount', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'AppliedDiscount.value'
        db.alter_column(u'discount_applieddiscount', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))

        # Changing field 'AppliedDiscount.remaining'
        db.alter_column(u'discount_applieddiscount', 'remaining', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=4))


    def backwards(self, orm):
        
        # Changing field 'Discount.is_active'
        db.alter_column(u'discount_discount', 'is_active', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Discount.value'
        db.alter_column(u'discount_discount', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'AppliedDiscount.value'
        db.alter_column(u'discount_applieddiscount', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))

        # Changing field 'AppliedDiscount.remaining'
        db.alter_column(u'discount_applieddiscount', 'remaining', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=10))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 11, 23, 44, 508747)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 11, 23, 44, 508402)'}),
        ...
        u'discount.applieddiscount': {
            'Meta': {'object_name': 'AppliedDiscount'},
            ...
            'remaining': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '18', 'decimal_places': '4'}),
            'tax_class': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shop.TaxClass']", 'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'value': ('django.db.models.fields.DecimalField', [], {'max_digits': '18', 'decimal_places': '4'})
        },
        u'discount.discount': {
            'Meta': {'object_name': 'Discount'},
            'allowed_uses': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'code': ('django.db.models.fields.CharField', [], {'default': "u'x5jmEV6HYh'", 'unique': 'True', 'max_length': '30'}),
            'config': ('plata.fields.JSONField', [], {'blank': 'True'}),
            'currency': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
